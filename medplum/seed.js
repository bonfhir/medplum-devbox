...
async function seedDatabase() {
    ...
    const systemRepo = (0, repo_1.getSystemRepo)();
    ...
    const superAdmin = await systemRepo.createResource({
        resourceType: 'User',
        firstName,
        lastName,
        email,
    ...
    const superAdminProject = await systemRepo.createResource({
    ...
    const practitioner = await systemRepo.createResource({
    ...
    // Add Default project
    const defaultProject = await systemRepo.updateResource({
        resourceType: 'Project',
    ...
    const defaultProjectPractitioner = await systemRepo.createResource({
        resourceType: 'Practitioner',
        meta: {
